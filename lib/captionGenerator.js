...
<<<<<<< HEAD
  const { productName = 'KB Furniture Item', category = 'living-room', materials = [], price, tone = 'modern', customPrompt = '' } = params;
=======
...
>>>>>>> 4cd674b4af49d0a4c0c576d40cf1680f0734cfca
  ...
  try {
<<<<<<< HEAD
    const promptText = `Generate 3 distinct social media caption options for a luxury Scandinavian furniture brand named "KB Furniture Scandinavian Studio".
=======
